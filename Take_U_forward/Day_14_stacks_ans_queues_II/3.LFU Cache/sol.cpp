class LFUCache {
    ...
    void insert(int key, int frequency, int value) {
        ...
        // Updates the cache map with the new frequency and the iterator pointing to the newly inserted pair.
    }
...
public:
    ...
    int get(int key) {
        ...
        // If the list becomes empty, erase that frequency entry from frequencies. Moreover, if this frequency was the minimum (minf), increment minf
        ...
        // Reinsert the key with an incremented frequency (frequency + 1) using the insert function.
